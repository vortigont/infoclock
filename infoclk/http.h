...
// content types
static const char PROGMEM PGmimetxt[]  = "text/plain";
static const char PROGMEM PGmimehtml[] = "text/html";
static const char PROGMEM PGmimejson[] = "application/json";
...
static const char PROGMEM PGota[] = "OTA update in progress...";
static const char PROGMEM PGotaform[] = "<form method='POST' action='/update' enctype='multipart/form-data'><input type='file' name='update'><input type='submit' value='Update'></form>";

// sprintf template for json config data
static const char PROGMEM PGcfgjson[] = "{\"wH\":\"%s\",\"wM\":%u,\"wS\":\"%s\", \"uU\":\"%s\"}";

// Index page with config form
// (this is a minimized version)
static const char PROGMEM PGindex[] = R"===(
