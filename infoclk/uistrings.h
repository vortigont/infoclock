...
static constexpr const char V_CLKPIN[] PROGMEM = "mx_csp";      // CLK pin
static constexpr const char V_DATAPIN[] PROGMEM = "mx_clkp";    // DATA pin
static constexpr const char V_CSPIN[] PROGMEM = "mx_dtp";       // CS pin
